...
# No ARM CLI binary is published yet; set this only to a compatible ARM build.
CLI_DOWNLOAD_URL=""
...
load_language() {
    ...
    1)
        ...
        msg_cli_unavailable="The CLI tool is not yet available for this ARM architecture. WEB access remains unchanged."
        ...
        msg_web_ui_change_notice_detail="If WEB access is disabled, the web page will be unreachable. The CLI tool is not yet available for this ARM architecture. To restore web access, choose Enable WEB access from this script."
        ...
        msg_web_ui_disabled_start_tip="WEB access is disabled. To restore web access, choose Enable WEB access from this install script."
    ...
    2)
        ...
        msg_cli_unavailable="当前 ARM 架构尚未发布命令行工具，WEB 访问设置保持不变。"
        ...
        msg_web_ui_change_notice_detail="关闭 WEB 访问后，网页端将不可访问。当前 ARM 架构尚未发布命令行工具。如需恢复网页访问，请在本安装脚本中选择开启 WEB 访问。"
        ...
        msg_web_ui_disabled_start_tip="当前 WEB 访问已关闭。如需恢复网页访问，请在本安装脚本中选择开启 WEB 访问。"
